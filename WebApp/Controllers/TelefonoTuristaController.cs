...
{
    public class TelefonoTuristaController : Controller
    {
        TelefonoTuristaData _data = new TelefonoTuristaData();
        ...
        [HttpPost]
        public IActionResult Guardar(TelefonoTurista obj)
        {
        ...
        [HttpPost]
        public IActionResult Editar(TelefonoTurista obj)
        {
            if (!ModelState.IsValid)
                return View();
        ...
        [HttpPost]
        public IActionResult Eliminar(TelefonoTurista obj)
        {
